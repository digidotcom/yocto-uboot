...
#define USBOTG_REG32(offset)	(*((volatile u32 *)(USB_OTGREGS_BASE + (offset))))
#define USBOTG_REG16(offset)	(*((volatile u16 *)(USB_OTGREGS_BASE + (offset))))

#define USBH1_REG32(offset)	(*((volatile u32 *)(USB_H1REGS_BASE + (offset))))
#define USBH1_REG16(offset)	(*((volatile u16 *)(USB_H1REGS_BASE + (offset))))

#define USBH2_REG32(offset)	(*((volatile u32 *)(USB_H2REGS_BASE + (offset))))
#define USBH2_REG16(offset)	(*((volatile u16 *)(USB_H2REGS_BASE + (offset))))

#define USBOTHER_REG(offset)	(*((volatile u32 *)(USB_OTHERREGS_BASE + (offset))))
...
#define UH1_ULPIVIEW		USBH1_REG32(0x170)	/* ULPI viewport */
