 ...
 */
#define CONFIG_CPX2			1	/* in a CPX2 */
...
# define CONFIG_CONSOLE			"ttyAM"
#endif
#define CONFIG_DISABLE_CTRLC	/* Disable CTRL-C */
#define CONFIG_CONS_INDEX		0

/* Unsupported common options for CPX2 must be disabled */
...
#define CONFIG_PHY_RESET_GPIO		PINID_PWM4		/* for CPX2 */
...
# ifdef CONFIG_SILENT_CONSOLE_GPIO_ALT1
#  define ENABLE_CONSOLE_GPIO		PINID_SAIF1_SDATA0	/* (3, 26) */
# else
#  define ENABLE_CONSOLE_GPIO		PINID_LCD_RESET		/* (3, 30) */
# endif /* CONFIG_SILENT_CONSOLE_GPIO* */
