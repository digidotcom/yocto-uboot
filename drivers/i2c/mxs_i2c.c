...
extern int mx28_reset_block(struct mx28_register *reg);

void mxs_i2c_reset(void)
{
	struct mx28_i2c_regs *i2c_regs = (struct mx28_i2c_regs *)CONFIG_SYS_I2C_PORT;
	int ret;
...
void i2c_init(int speed, int slaveadd)
{
	...
	case 400000:
		...
		break;
	default:
		debug("MXS I2C: Invalid speed selected (%d Hz)\n", speed);
		return;
	}
