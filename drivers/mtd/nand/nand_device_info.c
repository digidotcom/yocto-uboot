...
static struct nand_device_info nand_device_info_table_type_2[] =
{
	...
	.data_hold_in_ns          = 5,
	.address_setup_in_ns      = 10,
	.gpmi_sample_delay_in_ns  = 10,	/* DELAY = tREA + 4ns - tRP */
	.tREA_in_ns               = 16,
	.tRLOH_in_ns              = 5,
	.tRHOH_in_ns              = 15,
	"MT29F1G08ABADA",
...
static struct nand_device_info *nand_device_info_fn_amd(const uint8_t id[])
{
	struct nand_device_info  *table;
