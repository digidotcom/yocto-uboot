...
#ifndef CONFIG_VDDA_BO_STEPS
#define CONFIG_VDDA_BO_STEPS	0x7	/* default VDDA BO steps */
#endif

#ifdef CONFIG_VDDD_BO_MV_BELOW
#define VDDD_BO_VOLTAGE		(VDDD(CONFIG_CPU_FREQ) - CONFIG_VDDD_BO_MV_BELOW)
#else
#define VDDD_BO_VOLTAGE		1000	/* default VDDD BO voltage */
#endif

#ifndef CONFIG_BATT_BO_STEPS
#define CONFIG_BATT_BO_STEPS	0xf	/* default VDDA BO steps */
#endif

#ifndef CONFIG_VDDIO_BO_VOLTAGE
#define CONFIG_VDDIO_BO_VOLTAGE	3150
#endif
